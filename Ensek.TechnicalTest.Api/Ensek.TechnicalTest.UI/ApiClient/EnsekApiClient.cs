...
namespace Ensek.TechnicalTest.Api.Client
{
    ...
    public partial class EnsekApiClient : IEnsekApiClient
    {
        ...
        public virtual async System.Threading.Tasks.Task<MeterReadingUploadResponse> MeterReadingUploadsAsync(FileParameter csvFile, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (csvFile == null)
                        throw new System.ArgumentNullException("csvFile");
                    else
                    {
                        var content_csvFile_ = new System.Net.Http.StreamContent(csvFile.Data);
                        if (!string.IsNullOrEmpty(csvFile.ContentType))
                            content_csvFile_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse(csvFile.ContentType);
                        content_.Add(content_csvFile_, "csvFile", csvFile.FileName ?? "csvFile");
                    }
